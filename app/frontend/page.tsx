...
const data2 = [
    ...
    },
    {
        ...
        title: "Tailwind",
        desc: "A React & Node Based website to help you find what dishes you can make if u have certain ingredients",
        img: "/../public/tailwind.jpeg",
    },
    {
        id: 5,
        title: "Angular",
        desc: "A React & Node Based website to help you find what dishes you can make if u have certain ingredients",
        img: "/../public/angular.png",
    },
];
...
const FRONTEND = () => {
    return (
        <div className='container'>
            <div className="bg-black h-[60vh] flex flex-col md:flex-row md:justify-between md:bg-center bg-cover front-img md:h-[60vh] sm:h-[30vh]">
                {/* TEXT CONTAINER */}
                <div className="flex-1 flex flex-col justify-center items-center text-center gap-8 pt-40">
                    <h1 className="text-white text-5xl font-bold xl:text-6xl">FRONTEND DEVELOPMENT</h1>
                </div>
                {/* IMAGE CONTAINER */}
            </div>
            ...
            <div id="about" className="px-10 lg:px-32 dark:bg-white">
                ...
                >
                    ...
                    <div className="my-auto flex flex-col gap-3">
                        <h1 className="text-indigo-600 text-3xl font-bold">What is Fronted Development?</h1>
